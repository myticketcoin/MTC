Contributing to MyTicketCoin Core
==================================

The MyTicketCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MyTicketCoin Core project, and is not to be
confused with overall MyTicketCoin Network Protocol consensus changes.

Whether a pull request is merged into MyTicketCoin Core rests with the project merge
...
Patches that change MyTicketCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MyTicketCoin consensus, it must have been
...
The project leader is the release manager for each MyTicketCoin Core release.
