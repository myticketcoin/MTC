...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MyTicketCoin Core MyTicketCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MyTicketCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MyTicketCoin transaction") + "\n" +
                               "  MyTicketCoin-tx [options] -create [commands]   " + _("Create hex-encoded MyTicketCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MyTicketCoin transaction
