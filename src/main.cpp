...
#if defined(NDEBUG)
#error "MyTicketCoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(IsTreasuryBlock(nHeight)) {
     ...
     } else if (nHeight == 1)                          { nSubsidy = 750000 * COIN; //premimed 4.82%
    } else if (nHeight > 1 && nHeight <= 14400)       { nSubsidy = 8 * COIN;
    } else if (nHeight > 14400 && nHeight <= 57600)  { nSubsidy = 8 * COIN;
    } else if (nHeight > 57600 && nHeight <= 115200) { nSubsidy = 4.5 * COIN;
    } else if (nHeight > 115200 && nHeight <= 172800) { nSubsidy = 5 * COIN;
    } else if (nHeight > 172800 && nHeight <= 259200) { nSubsidy = 5.25 * COIN;
    } else if (nHeight > 259200 && nHeight <= 345600) { nSubsidy = 5.5 * COIN;
    } else if (nHeight > 345600 && nHeight <= 518400) { nSubsidy = 5.25 * COIN;
    } else if (nHeight > 518400 && nHeight <= 864000) { nSubsidy = 5 * COIN;
    } else if (nHeight > 864000 && nHeight <= 1728000) { nSubsidy = 4 * COIN;
    } else if (nHeight > 1728000) { nSubsidy = 2 * COIN; }
...
{
          if (nHeight <= 14400) { return 1 * COIN;
        } else if (nHeight > 14400 && nHeight <= 57600) { return 4 * COIN;
        } else if (nHeight > 57600 && nHeight <= 115200) { return 3.5 * COIN;
        } else if (nHeight > 115200 && nHeight <= 172800) { return 3 * COIN;
        } else if (nHeight > 172800 && nHeight <= 259200) { return 2.75 * COIN;
        } else if (nHeight > 259200 && nHeight <= 345600) { return 2.5 * COIN;
        } else if (nHeight > 345600 && nHeight <= 518400) { return 2.75 * COIN;
        } else if (nHeight > 518400 && nHeight <= 864000) { return 3 * COIN;
        } else if (nHeight > 864000 && nHeight <= 1782000) { return 3.99 * COIN;
        } else if (nHeight > 1782000) { return  1 * COIN; }
return 0;
}
...
{
    RenameThread("MyTicketCoin-scriptch");
