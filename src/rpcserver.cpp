...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MyTicketCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "MyTicketCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MyTicketCoin features */
        {"MyTicketCoin", "masternode", &masternode, true, true, false},
        {"MyTicketCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"MyTicketCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"MyTicketCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"MyTicketCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"MyTicketCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"MyTicketCoin", "startmasternode", &startmasternode, true, true, false},
        {"MyTicketCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"MyTicketCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"MyTicketCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"MyTicketCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"MyTicketCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"MyTicketCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"MyTicketCoin", "mnbudget", &mnbudget, true, true, false},
        {"MyTicketCoin", "preparebudget", &preparebudget, true, true, false},
        {"MyTicketCoin", "submitbudget", &submitbudget, true, true, false},
        {"MyTicketCoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"MyTicketCoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"MyTicketCoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"MyTicketCoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"MyTicketCoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"MyTicketCoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"MyTicketCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"MyTicketCoin", "checkbudgets", &checkbudgets, true, true, false},
        {"MyTicketCoin", "mnsync", &mnsync, true, true, false},
        {"MyTicketCoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> MyTicketCoin-cli " + methodname + " " + args + "\n";
}
