                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MyTicketCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MyTicketCoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MyTicketCoin"), this);
    aboutAction->setStatusTip(tr("Show information about MyTicketCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MyTicketCoin"));
    ...
    openAction->setStatusTip(tr("Open a MyTicketCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MyTicketCoin help message to get a list with possible MyTicketCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MyTicketCoin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MyTicketCoin network", "", count));
}
...
{
    QString strTitle = tr("MyTicketCoin"); // default title
